...
struct TabViewTest: View {
    var body: some View {
        ...
        TabView {
            ...
            Text("")
                .tabItem {
                    SFSymbols.QUESTION_MARK_CIRCLE
                    Text("Help")
                }
            Text("")
                .tabItem {
                    SFSymbols.QUESTION_MARK_CIRCLE_FILL
                    Text("Help")
                }
            Text("")
                .tabItem {
                    SFSymbols.QUESTION_MARK_SQUARE
                    Text("Help")
                }
            Text("")
                .tabItem {
                    SFSymbols.QUESTION_MARK_SQUARE_FILL
                    Text("Help")
                }
            Text("")
                .tabItem {
                    SFSymbols.QUESTION_MARK
                }
            Text("")
                .tabItem {
                    SFSymbols.HAND_WAVE
